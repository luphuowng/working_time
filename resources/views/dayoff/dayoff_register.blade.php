        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Đăng ký nghỉ phép</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
    ...
    <section class="content">
        ...
        <div class="col-md-6">
          <div class="card card-primary">
            ...
            <div class="card-body">
              ...
              <div class="form-group">
                <label for="inputProjectLeader">Ngày kết thúc</label>
                <input type="date" id="inputProjectLeader" class="form-control">
              </div>
              <div class="form-group">
                <label for="inputDescription">Lý do nghỉ</label>
      ...
      <div class="row">
        <div class="col-12">
          ...
          <input type="submit" value="Đăng ký nghỉ phép" class="btn btn-success float-left">
        </div>
      </div>
    </section>
    <!-- /.content -->
